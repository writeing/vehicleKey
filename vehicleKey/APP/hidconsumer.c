...
static void hidEmuStateCB (gapRole_States_t newState, gapRoleEvent_t *pEvent) {
    ...
    case GAPROLE_CONNECTED: {
        ...
        // PRINT ( "directAddressType=%x devAddr",event->devAddrType );  //��ȡ��ַ����
        // for(int i=0; i<6; i++)
        // {
        //     PRINT ( " %x ",pEvent->linkCmpl.devAddr[i]);//��ӡ��ַ
        // }
        // PRINT ( "\n addr ");
        // for(int i=0; i<6; i++)
        // {
        //     PRINT ( " %x ",pEvent->deviceInfo.addr[i]);//��ӡ��ַ
        // }
        // PRINT ( "\n addr ");
        // for(int i=0; i<6; i++)
        // {
        //     PRINT ( " %x ",pEvent->initDone.devAddr[i]);//��ӡ��ַ
        // }
        // uint8_t Buffer[6];
